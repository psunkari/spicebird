...
MessageTabDisplayWidget.prototype = {
  ...
  onSelectedMessagesChanged:
    ...
    if (this.folderDisplay.view.dbView.rowCount == 0) {
      if (!this.closing) {
        this.closing = true;
        document.getElementById('tabcollab').closeTab(
      ...
      if (!this.closing)
        document.getElementById('tabcollab').setTabTitle(
            this.folderDisplay._tabInfo);
  ...
  clearDisplay: function MessageTabDisplayWidget_clearDisplay() {
    if (!this.closing) {
      this.closing = true;
      document.getElementById('tabcollab').closeTab(this.folderDisplay._tabInfo);
    }
  }
};

...
FolderDisplayWidget.prototype = {
  ...
  show: function FolderDisplayWidget_show(aFolder) {
    ...
    if (this._tabInfo)
      document.getElementById('tabcollab').setTabTitle(this._tabInfo);
  },
  ...
  onFolderLoading: function(aFolderLoading) {
    if (this._tabInfo)
      document.getElementById("tabcollab").setTabBusy(this._tabInfo,
                                                    aFolderLoading);
  },
  ...
  onSearching: function(aIsSearching) {
    if (this._tabInfo) {
      ...
      document.getElementById("tabcollab").setTabThinking(
        this._tabInfo,

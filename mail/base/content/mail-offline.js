...
var MailOfflineMgr = {
  ...
  init: function()
  {
    ...
    this.brandShortName = brandBundle.getString("brandShortName");
  ...
  goOnlineToSendMessages: function(aMsgWindow)
  {
    ...
    var goOnlineToSendMsgs = promptService.confirm(window, 
                                ...
                                this.offlineBundle.getFormattedString('sendMessagesOfflineLabel1', [this.brandShortName]));
  ...
  confirmSendUnsentMessages: function()
  {
    ...
    var sendUnsentMessages = promptService.confirmEx(window, 
                                                     ...
                                                     this.offlineBundle.getString('sendMessagesLabel2', [this.brandShortName]),
  ...
  updateOfflineUI: function(aIsOffline)
  {
    ...
    if (aIsOffline)
    {
      ...
      statusBarPanel.setAttribute("tooltiptext",
                                  this.offlineBundle.getFormattedString("offlineTooltip", [this.brandShortName]));
    }
    else
    {
      statusBarPanel.removeAttribute("offline");
      statusBarPanel.setAttribute("tooltiptext",
                                  this.offlineBundle.getFormattedString("onlineTooltip", [this.brandShortName]));
    }    
  },   

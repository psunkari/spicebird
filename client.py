...
DEFAULT_COMM_REV = "SPICEBIRD_08"

# URL of the default hg repository to clone for Mozilla.
DEFAULT_MOZILLA_REPO = 'http://hg.mozilla.org/releases/mozilla-1.9.1/'
DEFAULT_MOZILLA_REV = "THUNDERBIRD_3_0_6_RELEASE"
...
o.add_option("-s", "--spicebird-repo", dest="comm_repo",
             default=None,
             help="URL of Spicebird repository to pull from (default: use hg default in .hg/hgrc)")
o.add_option("--skip-spicebird", dest="skip_comm",
             action="store_true", default=False,
             help="Skip pulling the Spicebird repository.")
o.add_option("--spicebird-rev", dest="comm_rev",
             default=DEFAULT_COMM_REV,
             help="Revision of Spicebird repository to update to. Default: \"" + DEFAULT_COMM_REV + "\"")
...
if action in ('checkout', 'co'):
    ...
    if (not options.skip_inspector or not options.skip_venkman) and \
        ...
        sys.exit("Error: mozilla/extensions directory does not exist;" + \
                 " DOM Inspector and/or Venkman cannot be checked out!")

...
var calendarController = {
    ...
    isCommandEnabled: function cC_isCommandEnabled(aCommand) {
        switch (aCommand) {
            ...
            case "calendar_modify_event_command":
                return this.single_item_selected;
            ...
            case "calendar_modify_todo_command":
                 return this.todo_items_selected &&
                        gCurrentApplication == gTasksAppName;
    ...
    doCommand: function cC_doCommand(aCommand) {
        switch (aCommand) {
            ...
            case "calendar_new_calendar_command":
                ...
                break;
            case "calendar_edit_calendar_command":
                var calendar = gCurrentApplication == gCalendarAppName ?
                               getSelectedCalendar(): getSelectedTasksCalendar();
            ...
            case "calendar_publish_selected_calendar_command":
                var calendar = gCurrentApplication == gCalendarAppName ?
                               getSelectedCalendar(): getSelectedTasksCalendar();
                publishEntireCalendar(calendar);
                break;
    ...
    isCalendarInForeground: function cC_isCalendarInForeground() {
        // For spicebird, check if the current app is calendar or tasks
        return gCurrentApplication == gCalendarAppName || 
               gCurrentApplication == gTasksAppName;
    },

    isInMode: function cC_isInMode(mode) {
      return gCurrentApplication == mode;
    },
    ...
    onSelectionChanged: function cC_onSelectionChanged(aEvent) {
        ...
        calendarController.single_item_selected = selectedItems && (selectedItems.length == 1);
        ...
        document.commandDispatcher.updateCommands('framework-toolbar');
    },

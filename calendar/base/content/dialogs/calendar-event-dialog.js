...
function updateToDoStatus(status, passedInCompletedDate) {
  ...
  switch (status) {
      ...
      case "NONE":
          ...
          collapseElement("percent-complete-textbox");
          collapseElement("percent-complete-label");
          break;
      case "CANCELLED":
      ...
      case "IN-PROCESS":
          ...
          collapseElement("completed-date-picker");
          uncollapseElement("percent-complete-textbox");
          uncollapseElement("percent-complete-label");
          break;
      case "NEEDS-ACTION":
  ...
  if (status == "COMPLETED") {
      ...
      uncollapseElement("completed-date-picker");
  } else {

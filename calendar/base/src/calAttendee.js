...
calAttendee.prototype = {
    ...
    set icalProperty (icalatt) {
        ...
        // XXX: Have a clean implementation for this hack
        // Apple Calendar Server does not use email as the value anymore!
        if (icalatt.getParameter("EMAIL"))
          this.id = "mailto:" + icalatt.getParameter("EMAIL");

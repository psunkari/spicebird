 ...
 *    Sivakrishna Edupuganti <sivakrishna@synovel.com>
 *
...
function SetAbView(aURI)
{
  ...
  observerService.notifyObservers(window, "abview:create", "");
  ...
  UpdateAbSortIndicators(actualSortColumn, sortDirection);
}
...
{
  UpdateAbSortIndicators(sortColumn, sortDirection);

  if (gAbView)
    gAbView.sortBy(sortColumn, sortDirection);
}

function UpdateAbSortIndicators(colID, sortDirection)
{

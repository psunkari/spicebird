...
$clean_l10ndir = 0; # remove l10ndir when starting release cycle?
$LocaleProduct = "collab";
$shiptalkback  = 0;
...
$ssh_opts      = "-p 1301";
$scp_opts      = "-P 1301";
$ftp_path      = "/var/www/html/files/pub/spicebird.org/spicebird/stage";
$url_path      = "http://files.spicebird.org/pub/spicebird.org/spicebird/stage";
...
$update_aus_path = '/home/aus/incoming_aus_data/stage';

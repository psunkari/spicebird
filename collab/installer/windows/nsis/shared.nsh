...
!macro PostUpdate
  ...
  ; install location in the Software\Synovel key and uninstall registry entries
  ; that point to our install location for both HKCU and HKLM.
  SetShellVarContext current  ; Set SHCTX to the current user (e.g. HKCU)
  ${RegCleanMain} "Software\Synovel"
  ${RegCleanUninstall}
...
!macro SetHandlersMail
  ...
  ; An empty string is used for the 5th param because Spicebird.EML is not a
  ; protocol handler
  ${AddHandlerValues} "$0\Spicebird.EML"  "$1" "$8,0" \
                      "${AppRegNameMail} Document" "" ""
  ${AddHandlerValues} "$0\Spicebird.MAILTO"  "$2" "$8,0" "${AppRegNameMail} URL" "true" ""
  ${AddHandlerValues} "$0\mailto" "$2" "$8,0" "${AppRegNameMail} URL" "true" ""

  ; Associate the file handlers with Spicebird.EML
  ReadRegStr $6 SHCTX ".eml" ""
  ${If} "$6" != "Spicebird.EML"
    WriteRegStr SHCTX "$0\.eml"   "" "Spicebird.EML"
  ${EndIf}
!macroend
...
!macro SetHandlersNews
  ...
  ${AddHandlerValues} "$0\Spicebird.NEWS" "$1" "$8,0" \
...
!macro SetHandlersCalendar
  ${GetLongPath} "$INSTDIR\${FileMainEXE}" $8
  StrCpy $0 "SOFTWARE\Classes"
  StrCpy $1 "$\"$8$\" -osint -import-events $\"%1$\""

  ; An empty string is used for the 5th param because
  ; Spicebird.ICS is not a protocol handler
  ${AddHandlerValues} "$0\Spicebird.ICS"  "$1" "$8,0" \
...
!macro SetClientsMail
  ...
  WriteRegStr HKLM "$0\Capabilities\FileAssociations" ".eml"   "Spicebird.EML"
  WriteRegStr HKLM "$0\Capabilities\FileAssociations" ".wdseml" "Spicebird.EML"
  WriteRegStr HKLM "$0\Capabilities\StartMenu" "Mail" "${ClientsRegName}"
  WriteRegStr HKLM "$0\Capabilities\URLAssociations" "mailto" "Spicebird.MAILTO"
...
!macro SetClientsNews
  ...
  WriteRegStr HKLM "$0\Capabilities\URLAssociations" "nntp" "Spicebird.NEWS"
  WriteRegStr HKLM "$0\Capabilities\URLAssociations" "news" "Spicebird.NEWS"
  WriteRegStr HKLM "$0\Capabilities\URLAssociations" "snews" "Spicebird.NEWS"
...
!macro SetClientsCalendar
  ...
  WriteRegStr HKLM "$0\shell\open\command" "" "$\"$8$\" -calendar"

  ; Vista Capabilities registry keys
  WriteRegStr HKLM "$0\Capabilities" "ApplicationDescription" "$(REG_APP_DESC)"
  WriteRegStr HKLM "$0\Capabilities" "ApplicationIcon" "$8,0"
  WriteRegStr HKLM "$0\Capabilities" "ApplicationName" "${AppRegNameCalendar}"
  WriteRegStr HKLM "$0\Capabilities\FileAssociations" ".ics"   "Spicebird.ICS" 

  ; Vista Registered Application
  WriteRegStr HKLM "Software\RegisteredApplications" "${AppRegNameCalendar}" "$0\Capabilities"
!macroend
!define SetClientsCalendar "!insertmacro SetClientsCalendar"

!macro SetAppKeys
  ${GetLongPath} "$INSTDIR" $8
  StrCpy $0 "Software\Synovel\${BrandFullNameInternal}\${AppVersion} (${AB_CD})\Main"
  ${WriteRegStr2} $TmpVal "$0" "Install Directory" "$8" 0
  ${WriteRegStr2} $TmpVal "$0" "PathToExe" "$8\${FileMainEXE}" 0

  StrCpy $0 "Software\Synovel\${BrandFullNameInternal}\${AppVersion} (${AB_CD})\Uninstall"
  ${WriteRegStr2} $TmpVal "$0" "Description" "${BrandFullNameInternal} (${AppVersion})" 0

  StrCpy $0 "Software\Synovel\${BrandFullNameInternal}\${AppVersion} (${AB_CD})"
  ${WriteRegStr2} $TmpVal  "$0" "" "${AppVersion} (${AB_CD})" 0

  StrCpy $0 "Software\Synovel\${BrandFullNameInternal} ${AppVersion}\bin"
  ${WriteRegStr2} $TmpVal "$0" "PathToExe" "$8\${FileMainEXE}" 0

  StrCpy $0 "Software\Synovel\${BrandFullNameInternal} ${AppVersion}\extensions"
  ${WriteRegStr2} $TmpVal "$0" "Components" "$8\components" 0
  ${WriteRegStr2} $TmpVal "$0" "Plugins" "$8\plugins" 0

  StrCpy $0 "Software\Synovel\${BrandFullNameInternal} ${AppVersion}"
  ${WriteRegStr2} $TmpVal "$0" "GeckoVer" "${GREVersion}" 0

  StrCpy $0 "Software\Synovel\${BrandFullNameInternal}"
...
!macro SetUninstallKeys
  ...
  ${WriteRegStr2} $1 "$0" "Publisher" "Synovel" 0
...
!macro UpdateProtocolHandlers
  ...
  ${IsHandlerForInstallDir} "Spicebird.EML" $R9
  ${If} "$R9" == "true"
    ${AddHandlerValues} "SOFTWARE\Classes\Spicebird.EML" "$3" "$8,0" \
                        "${AppRegNameMail} Document" "" ""
  ${EndIf}

  ${IsHandlerForInstallDir} "Spicebird.MAILTO" $R9
  ${If} "$R9" == "true"
    ${AddHandlerValues} "SOFTWARE\Classes\Spicebird.MAILTO" "$1" "$8,0" \
  ...
  ${IsHandlerForInstallDir} "Spicebird.NEWS" $R9
  ${If} "$R9" == "true"
    ${AddHandlerValues} "SOFTWARE\Classes\Spicebird.NEWS" "$2" "$8,0" \
                        "${AppRegNameNews} URL" "true" ""
  ${EndIf}
...
!macro CreateShortcutsLog
  ...
  ${Unless} ${FileExists} "$0"
    ...
    ClearErrors
    ReadRegStr $0 SHCTX "Software\Synovel\${BrandFullNameInternal}\${AppVersion} (${AB_CD})\Main" "Start Menu Folder"
    ${If} ${Errors}
      ${FindSMProgramsDir} $0
      ${If} "$0" != ""
        StrCpy $TmpVal "$0"

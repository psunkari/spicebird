...
tier_app_dirs += collab/branding/nightly
endif
...
package-compare:
	@$(MAKE) -C collab/installer package-compare

install::
	@$(MAKE) -C collab/installer install

source-package::
	@$(MAKE) -C collab/installer source-package

upload::
	@$(MAKE) -C collab/installer upload

...
// XXX: Actually we should see if the could become a prototype
// so we onyle have to overwrite :  - onImportItemsPageShow
//                                  - _listItems

var csMigrationWizard = {
  ...
  onImportSourcePageShow: function ()
  {
    ...
    if(!this._autoMigrate) {
      // Thunderbird and Seamonkey profiles can not be imported into a live 
      // profile. Disabling them.
      var thunderbirdRadio = document.getElementById("thunderbird");
      thunderbirdRadio.hidden = true;
      var seamonkeyRadio = document.getElementById("seamonkey");
      seamonkeyRadio.hidden = true;
    }
  ...
  onImportItemsPageShow: function ()
  {
    ...
    var csBundle = document.getElementById("csBundle");
    ...
    for (var i = 0; i < 16; ++i) {
      ...
      if (itemID > 0) {
        ...
        if (this._source == "thunderbird")
          checkbox.setAttribute("label", csBundle.getString(itemID + "_" + this._source));
        else
  ...
  _listItems: function (aID)
  {
    ...
    for (var i = 0; i < 16; ++i) {
      ...
      if (itemID > 0) {
        ...
        try {
          if (this._source == "thunderbird") {
            label.setAttribute("value", "- " + csBundle.getString(itemID + "_" + this._source));
          }
          else
...
MigrationWizard = csMigrationWizard;

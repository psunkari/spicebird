...
// APP_REG_NAME_MAIL, APP_REG_NAME_NEWS and APP_REG_NAME_CAL should be kept in
// sync with AppRegNameMail, AppRegNameNews and AppRegNameCalendar in the installer
// file: defines.nsi.in
#define APP_REG_NAME_MAIL L"Spicebird"
#define APP_REG_NAME_NEWS L"Spicebird News"
#define APP_REG_NAME_CAL  L"Spicebird Calendar"
#define CLS_EML            "Spicebird.EML"
#define CLS_ICS            "Spicebird.ICS"
#define CLS_MAILTOURL      "Spicebird.MAILTO"
#define CLS_NEWSURL        "Spicebird.NEWS"
#define CLS_FEEDURL        "Spicebird.FEED"
#define SOP                "\\shell\\open\\command"

#define VAL_OPEN "\"%APPPATH%\" \"%1\""
#define VAL_MAIL_OPEN "\"%APPPATH%\" -osint -mail \"%1\""
#define VAL_COMPOSE_OPEN "\"%APPPATH%\" -osint -compose \"%1\""
#define VAL_ICS_OPEN "\"%APPPATH%\" -osint -import-events \"%1\""
...
static SETTING gCalendarSettings[] = {
  ...
  // File Extension Class
  { MAKE_KEY_NAME1(CLS_ICS, SOP), "",  VAL_ICS_OPEN, APP_PATH_SUBSTITUTION },

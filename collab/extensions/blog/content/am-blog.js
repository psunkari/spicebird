...
function onPreInit(aAccount, aAccountValues)
{
  /* Fill the available list of blog types */
  var types = BlogUtils.supportedTypes;
  var typeMenuList = document.getElementById("server.blogType");
...
function onInit(aPageId, aServerId)
{
  ...
  var title = document.getElementById("am-blog-title");
...
function onBlogTypeChanged(event)
{
  ...
  var value = valueFormat.replace(/%s/,
